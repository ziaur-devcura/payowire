                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item"><a href="#" class="nav-link">Global Payment  <i class="fas fa-chevron-down"></i>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="globalaccount.php" class="nav-link">Multi Currency Bank Account USD, EURO, GBP </a></li>

                                        <li class="nav-item"><a href="reveivemoney.php" class="nav-link">Receive Money Globally</a></li>

                                        <li class="nav-item"><a href="sendmoney.php" class="nav-link">Send Money Globally</a></li>
                                        
                                        <li class="nav-item"><a href="bankwithdraw.php" class="nav-link">ACH, SEPA, WIRE TRANSFER </a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item"><a href="#" class="nav-link x">Cards <i class="fas fa-chevron-down"></i>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="virtualcard.php" class="nav-link">Unlimited Virtual card</a></li>
                                        
                            <li class="nav-item"><a href="virtualmastercard.php" class="nav-link">Virtual Mastercard Instantly</a></li>
                            
                               <li class="nav-item"><a href="virtualvisacard.php" class="nav-link">Virtual Visacard Instantly</a></li>
                                                        
                                        <li class="nav-item"><a href="physicalcard.php" class="nav-link">Physical Card For Payment</a></li>
