...
<head>
	...
	<style type="text/css">
		...
		img{height:auto;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;}
	...
	<style >
		@media only screen and (max-width: 699px) {
			...
			td.mo-h-0 { height: 0 !important; font-size: 0px !important; line-height: 0px !important; }
			td.spaceControl {height:15px!important;font-size:15px!important;line-height:15px!important;}
			table.bgColorChange { background-color: #FFFF00!important; }
		}
	</style>
</head>

<body style="-moz-osx-font-smoothing:grayscale;-ms-text-size-adjust:100%;-webkit-font-smoothing:antialiased;-webkit-text-size-adjust:100%;margin:0!important;mso-line-height-rule:exactly;padding:0 !important;width:100% !important;">
<center>



<!-- Menu Open -->
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F7F7F7" style="width:100%;max-width:100%;">
	<tr>
											...
											<tr>
												<td align="center" valign="top">
													<a href="{{route('homeview')}}">
														<img  src="{{URL::asset('frontend/assets/img/black-logo.png')}}" width="130" alt="" style="display:block;border:0;width:130px;">
													</a>
												</td>
											</tr>
										</table>
				...
				<tr>
					<td align="center" valign="top" bgcolor="#FFFFFF">
						...
						<table class="row" border="0" width="100%" align="center" cellpadding="0" cellspacing="0" style="width:100%;max-width:100%;">
							<tr>
								<td align="center" class="containerPadding" bgcolor="#FFFFFF" background="{{URL::asset('frontend/assets/img/bg-cta.png')}}" style="background-color:#FFFFFF;background-position:center top;background-size:cover;background-repeat:no-repeat;">

									<!--[if gte mso 9]>
									<v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:700px;height:292px;">
									...
									<table class="row" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;">
										...
										<tr>
											<td class="ctaTitle" align="center" valign="middle" style="font-family: 'Poppins', sans-serif;color:#FFFFFF;font-size:32px;line-height:46px;font-weight:600;letter-spacing:0px;padding:0;padding-bottom:30px;">
												Confirm Your Email
											</td>
										</tr>
										...
										<tr>
											<td align="center" valign="middle">
												<table border="0" align="center" cellpadding="0" cellspacing="0" class="centerFloat">
													<tr>
														<td align="center" style="background-color:#fd6509;display:block;mso-padding-alt:14px 34px 14px 34px;border-radius:50px;">
															<a href="{{route('activate_account',$code)}}" style="color:#FFFFFF;display:block;font-family:'Poppins',sans-serif;font-size:12px;font-weight:600;line-height:24px;padding:14px 34px 14px 34px;text-decoration:none;white-space:nowrap;">
																Activate Account
															</a>
														</td>
													</tr>
						...
						<table class="row" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;">
							...
							<tr>
								<td class="containerPadding" align="center" valign="top" style="font-size:0;padding:0">
									...
									<table class="row" border="0" width="600" align="center" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;">

										<tr>
											<td align="left" valign="middle" style="font-family:'Poppins',sans-serif;color:#fd6509;font-size:16px;line-height:26px;font-weight:700;letter-spacing:0px;padding:0px;padding-bottom:5px;">
												Dear {{$name}},
											</td>
										</tr>
										...
										<tr>
											<td align="left" valign="middle" style="font-family:'Poppins', sans-serif;color:#666666;font-size:14px;line-height:22px;font-weight:400;letter-spacing:0px;">
												Thank you for registering for <b>payowire.com</b>. To access your please do the following:<br><br>

1. Activating your account by clicking the following link: <a href="{{route('activate_account',$code)}}">{{route('activate_account',$code)}}</a><br>
2. Click the login link from <b>payowire.com</b> to access your account.<br>
3. Enjoy using your account<br><br>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F7F7F7" style="width:100%;max-width:100%;">
	<tr>
		<td align="center" valign="top">
			...
			<table class="row" width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="width:700px;max-width:700px;">
				<tr>
					<td align="center" valign="top" bgcolor="#191919">
						...
						<table class="row" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;">
							...
							<tr>
								<td align="center" valign="top" style="font-size:0;padding:0">
										...
										<table class="row" align="left" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td class=" centerText" align="left" valign="middle" style="font-family:'Open Sans',Arial,helvetica,sans-serif;color:#939393;font-size:14px;line-height:22px;font-weight:400;letter-spacing:0px;">
													 &copy; 2022 Payowire.com All Rights Reserved  
												</td>
											</tr>
										</table>
									</div>
									...
									<div class="row" style="display:inline-block;max-width:180px;vertical-align:top;width:100%">
										<table class="row" align="left" border="0" cellpadding="0" cellspacing="0">
									...
									<div class="row" style="display:inline-block;max-width:100px;vertical-align:middle;width:100%">
